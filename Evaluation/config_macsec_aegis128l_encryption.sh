...
sudo ip macsec add macsec0 rx address e8:27:eb:ed:6c:a3 port 1
sudo ip macsec add macsec0 rx address e8:27:eb:ed:6c:a3 port 1 sa 0 pn 1 on key 01 12345678901234567890123456789012
