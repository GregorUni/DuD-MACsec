...
sudo ip macsec add macsec0 rx address $2 port 1
sudo ip macsec add macsec0 rx address $2 port 1 sa 0 pn 1 on key 02 09876543210987654321098765432109
sudo ip link set dev macsec0 up
sudo ifconfig macsec0 $3/24
sudo ip link set dev macsec0 mtu 1514
sudo ip link set macsec0 type macsec encrypt $4
